...
class Monitor extends Component {
    ...
    confirmOrder() {
        ...
        axios.post("http://localhost:3001/orders", {orderedDate: new Date(), totalPrice, orders})
            .then(res =>{
                this.setState({totalPrice: 0, orders: [], confirm: true, msg:'บันทึกรายการสั้งซื้อเรียบร้อย'});
            })
        } else {
            this.setState({totalPrice: 0, orders: [], confirm: true, msg:'เลือสินค้าก่อนค่ะ'});
        }
    }
            ...
            <div className = "container-fluid">
                ...
                <div className ="row">
                    ...
                    <div className = "col-md -3">
                        <Calculator totalPrice={this.state.totalPrice} orders =  {this.state.orders} onDelOrder={this.delOrder} confirmOrder={this.confirmOrder} onCancelOrder={this.cancelOrder} />
                    </div>
